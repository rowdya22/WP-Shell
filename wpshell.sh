...
WPSHELL_DISALLOW_FILE_EDIT() { ${WPSKIP} eval 'echo defined("DISALLOW_FILE_EDIT") ? (DISALLOW_FILE_EDIT ? "true" : "false") : "not set";' 2>/dev/null; }
WPSHELL_SUCURISCAN_HIDE_ADS() { ${WPSKIP} eval 'echo defined("SUCURISCAN_HIDE_ADS") ? (SUCURISCAN_HIDE_ADS ? "true" : "false") : "not set";' 2>/dev/null; }
WPSHELL_WP_POST_REVISIONS() { ${WPSKIP} eval 'echo defined("WP_POST_REVISIONS") ? WP_POST_REVISIONS : "not set";' 2>/dev/null; }
WPSHELL_WP_CACHE() { ${WPSKIP} eval 'echo defined("WP_CACHE") ? (WP_CACHE ? "true" : "false") : "not set";' 2>/dev/null; }
WPSHELL_WP_DEBUG() { ${WPSKIP} eval 'echo defined("WP_DEBUG") ? "WP_DEBUG = " . (WP_DEBUG ? "true" : "false") : "WP_DEBUG not set";' 2>/dev/null; }
...
"${WPSHELL_TEXT_BOLD}File Editor:${WPSHELL_TEXT_RESET}" "$(WPSHELL_DISALLOW_FILE_EDIT)")
$(printf "%-32s %-20s %-32s %-20s\n" \
"${WPSHELL_TEXT_BOLD}Sucuri Ads Hidden:${WPSHELL_TEXT_RESET}" "$(WPSHELL_SUCURISCAN_HIDE_ADS)" \
"${WPSHELL_TEXT_BOLD}Post Revisions:${WPSHELL_TEXT_RESET}" "$(WPSHELL_WP_POST_REVISIONS)")
$(printf "%-32s %-20s %-32s %-20s\n" \
"${WPSHELL_TEXT_BOLD}WP Cache Enabled:${WPSHELL_TEXT_RESET}" "$(WPSHELL_WP_CACHE)" \
"${WPSHELL_TEXT_BOLD}WP Debug Mode:${WPSHELL_TEXT_RESET}" "$(WPSHELL_WP_DEBUG)")
"
}
